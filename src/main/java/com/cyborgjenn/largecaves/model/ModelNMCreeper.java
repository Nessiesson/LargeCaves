package com.cyborgjenn.largecaves.model;
...
public class ModelNMCreeper extends ModelBase {
	...
	public ModelNMCreeper(float size) {
		...
		RHornL.addBox(-3F, -10F, -1F, 1, 2, 1, size);
		...
		RHornU.addBox(-3F, -11.5F, 0.5F, 1, 2, 1, size);
		...
		LHornU.addBox(2F, -11.5F, 0.5F, 1, 2, 1, size);
