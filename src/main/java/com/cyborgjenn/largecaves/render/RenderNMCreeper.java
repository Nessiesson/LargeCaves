...
public class RenderNMCreeper extends RenderLiving<NMCRreeperEntity> {
	...
	protected void preRenderCallback(NMCRreeperEntity entitylivingbaseIn, float partialTickTime) {
	 ...
	 */
	protected int getColorMultiplier(NMCRreeperEntity entitylivingbaseIn, float lightBrightness, float partialTickTime) {
		float f = entitylivingbaseIn.getCreeperFlashIntensity(partialTickTime);
	...
	@Override
	protected ResourceLocation getEntityTexture(NMCRreeperEntity entity) {
