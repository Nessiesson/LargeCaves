...
public class CreeperCondoGen extends WorldGenerator {
	...
	private void placeSpawner(World world, BlockPos pos) { world.setBlockState(pos, Blocks.MOB_SPAWNER.getDefaultState());
		...
		if (tileentitymobspawner != null)
		{
			...
			tileentitymobspawner.getSpawnerBaseLogic().setEntityId(EntityList.getKey(EntityNMCreeper.class));
